...
//  
//  Custom implementation of a crazyyyyyy unknown controller by Nikolaj Hindsbo & Denis Alpay
// 
*/
...
PARAM_GROUP_START(ctrlCustom5)

PARAM_GROUP_STOP(ctrlCustom5)

LOG_GROUP_START(ctrlCustom5)

LOG_GROUP_STOP(ctrlCustom5)
