...
//     .alpha_z = 15, // Sliding mode control parameter original 4.0
//     .alpha_roll = 0.1,
//     .alpha_pitch = 0.1,
//     .I_xx = 16.571710E-06,
//     .I_yy = 16.655602E-06,
...
//     float output = k1 * pow(2, sliding_manifold) + k2 * error_pitch / (sign(sliding_manifold) + eps) - pitch_comp;
...
//     float output = k1 * pow(2, sliding_manifold) + k2 * error_roll / (sign(sliding_manifold) + eps) - roll_comp;
...
//     float target_roll_v = 0.0 * error_roll;
//     float target_pitch_v = 0.0 * error_pitch;

//     float error_d_z = 0.0 - current_state.vz;    
//     float error_d_roll = target_roll_v - current_state.vroll;
//     float error_d_pitch = target_pitch_v - current_state.vpitch;
