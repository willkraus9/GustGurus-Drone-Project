...
def generate_launch_description():
    ...
    world_file_path = "/home/denis/Desktop/crazyflie_ws/src/crazyflie_gazebo/models/crazyflie/crazyflie_world.sdf"

    pkg_project = get_package_share_directory('crazyflie_gazebo')
